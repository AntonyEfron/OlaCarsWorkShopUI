...
import {
  workshopStaffLogin,
  workshopManagerLogin,
} from "../services/authService";
import { setToken, setRefreshToken, setApiRole, setUser } from "../utils/auth";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-black">
      ...
      <div className="w-full max-w-md relative z-10 animate-fadeInUp">
        ...
        {/* Login Card */}
        <div
          className="glass-card p-8 backdrop-blur-2xl bg-[#00000044] rounded-2xl"
          ...
          <div className="flex bg-[#00000066] p-1.5 rounded-xl mb-8 border border-white/5 relative">
            ...
            <div
              ...
              style={{
                ...
                background:
                  loginRole === "staff" ? "var(--brand-lime)" : "#10b981",
              }}
            />
